# Haskell client Library for the Brainrex API
...
## Swagger Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Brainrex API Explorer`

The library in `lib` provides auto-generated-from-Swagger [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Brainrex API Explorer API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | BrainrexAPIExplorer                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | brainrex-api-explorer                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | BrainrexAPIExplorerConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | BrainrexAPIExplorerRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| BrainrexAPIExplorer.Client    | use the "dispatch" functions to send requests       |
| BrainrexAPIExplorer.Core      | core funcions, config and request types             |
| BrainrexAPIExplorer.API       | construct api requests                              |
| BrainrexAPIExplorer.Model     | describes api models                                |
| BrainrexAPIExplorer.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| BrainrexAPIExplorer.ModelLens | lenses for model fields                             |
| BrainrexAPIExplorer.Logging   | logging functions and utils                         |
